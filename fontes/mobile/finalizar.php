                      ...
                      <div class="list-block">
                        <ul>
                          ...
                          <li class="item-content">
                            ...
                            <div class="item-inner">
                              <div class="item-input">
                                <input type="text" onfocus="position('#cpf')"  id="cpf" name="cpf" placeholder="CPF" onblur="javascript: validarCPF(this.value);" onkeyup="javascript: mascara(this, cpf_mask);">
                              </div>
                            </div>
                          </li>
                          ...
                          <li class="item-content">
                            ...
                            <div class="item-inner">
                              <div class="item-input">
                                <input onfocus="position('#telefone')" type="text" class="telefone" id="telefone" name="telefone" placeholder="Seu telefone">
                              </div>
                            </div>
                          </li>
                          ...
                          <li class="item-content">
                            ...
                            <div class="item-inner">
                              <div class="item-input">
                                <input onfocus="position('#numero')" type="text" value="" id="numero" name="numero" placeholder="Número da sua residência" required>
                              </div>
                            </div>
                          </li>
                          ...
                          <li class="item-content">
                            ...
                            <div class="item-inner">
                              <div class="item-input">
                                <textarea onfocus="position('#obs')" id="obs" class="resizable" placeholder="Observação"></textarea>
                              </div>
                            </div>
                          </li>
