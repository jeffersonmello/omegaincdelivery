...
<head>
  ...
  $(document).ready(function(){
    myApp = new Framework7({material: true,   modalTitle: 'Delivery'});
  });
  ...
  function mesmo(guid,valor){
    ...
    function totaliza(){
      var taxadesconto  = localStorage.getItem("taxadesconto");
            ...
            success:function(dados){
              ...
              if ($(currentiten, listacarrinho).length){
                ...
                if (dados == 1){
                  ...
                  for (i = 15; i > 1; i++){
                    var proximoEspaco = nome.substring(i, (i + 1));

                    if (proximoEspaco == " "){
                      var textoCortado = nome.substring(0, i);
                      i = 0;
                    }
                  }
                  ...
                  listacarrinho.append("<li id='listacarrinho_"+guid+"'><div class='item-content'><div href='#' class='item-media' onclick='viewimage(\""+imagem+"\", \""+nomecompleto+"\", \""+nomecompleto+"\")'><i class='icon my-icon'><img class='circular' src='"+imagem+"' width='44'></i></div><div class='item-inner'><div class='item-title-row'><div class='item-title'>"+nome+"</div><div id='idvaloresqtde_"+guid+"' class='item-after'>R$ "+preco+" (1)</div></div><div class='item-subtitle'><a href='#' onclick='removeItem("+guid+","+preco+")' class='button color-red'><i class='material-icons color-icon'>delete</i></a></div></div></div></li>");
                  totaliza();
