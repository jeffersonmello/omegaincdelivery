...
echo '<table id="tableretirada" class="table table-hover table-bordered">'
...
$db->connect();
$db->sql("SELECT * FROM lanc_pedidos WHERE status='4' AND entregar = '0'");
$res = $db->getResult();
foreach ($res as $output) {
  ...
  echo "<td>$total</td>";
  echo "<td>$data</td>";
  echo "<td>Aguardando Retirado</td>";
  echo "<td width='65px'>
