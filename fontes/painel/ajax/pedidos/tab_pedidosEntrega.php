...
echo '<table id="pedidosEntrega" class="table table-hover table-bordered">'
...
$db->connect();
$db->sql("SELECT * FROM lanc_pedidos WHERE status='5' AND entregar = '1'");
$res = $db->getResult();
