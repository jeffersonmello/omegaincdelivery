<ul class="nav" id="side-menu">
  ...
  <li>
    ...
    <ul class="nav nav-second-level">
      <li><a href="cad_categoria.php" class=" hvr-bounce-to-right"> <i class="fa fa-indent nav_icon"></i>Categorias</a></li>

      <li><a href="cad_produtos.php" class=" hvr-bounce-to-right"><i class="fa fa-archive nav_icon"></i>Produtos</a></li>

      <li><a href="cad_bairros.php" class=" hvr-bounce-to-right"><i class="fa fa-map nav_icon"></i>Bairros</a></li>

      <li><a href="cad_usuarios.php" class=" hvr-bounce-to-right"><i class="fa fa-users nav_icon"></i>Usuários</a></li>

      <li><a href="cad_empresa.php" class=" hvr-bounce-to-right"><i class="fa fa-building nav_icon"></i>Empresa</a></li>
    </ul>
  </li>
